...
// यदि एडमिन लॉगिन नहीं है तो उसे login.php पर भेजें
if (!isset($_SESSION['emp_code'])) {
    header("Location: login.php");
    exit();
}

$admin_code = $_SESSION['emp_code']; // Admin का emp_code

// सिर्फ Admin की Attendance प्राप्त करें
$query = "SELECT * FROM attendance WHERE emp_code = '$admin_code' ORDER BY date DESC";
